...
Future<void> main() async {
  ...
  print(removed ? 'Video removed successfully.' : 'Failed to remove the video.');
}

Future<DateTime> getVideoAddedDate(String playlistId, String videoId) async {
  String url = 'https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&maxResults=50&playlistId=$playlistId&videoId=$videoId&key=$apiKey';
...
Future<bool> removeVideoFromPlaylist(String playlistId, String videoId) async {
  ...
  if (jsonResponse['items'].length > 0) {
    ...
    String deleteUrl = 'https://www.googleapis.com/youtube/v3/playlistItems?id=$playlistItemId&key=$apiKey';
